...
else
{
	...
	$updateqty = "UPDATE cart SET id = '$cartid', product_id = '$jewelid', qty = '$actualqty', cust_id = '$userid', checkout = '$checkout', added = '$today', checkedon = '', trans = '$code' WHERE cust_id = '$userid' AND product_id = '$jewelid' AND checkout = 'n'";
