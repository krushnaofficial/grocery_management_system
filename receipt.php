...
<?php
	...
	$sql = "SELECT COUNT(*) FROM cart , products, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'y' AND products.id = cart.product_id AND cart.checkedon = '$today' AND cart.trans = '$code'";
	...
	$selectproducts = "SELECT * FROM cart , products, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'y' AND products.id = cart.product_id AND cart.checkedon = '$today' AND cart.trans = '$code'";
...
<p>THANK YOU FOR CHOSING BB products</p>
