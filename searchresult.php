			...
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						{
							case 'name':
							$sql = "SELECT * FROM `products` WHERE (CONVERT(`prodname` USING utf8) LIKE '%".$search."%')";
							break;
							
							case 'desc':
							//$sql = "SELECT * FROM products WHERE `descr` LIKE '%".$search."%'";
							$sql = "SELECT * FROM `products` WHERE (CONVERT(`descr` USING utf8) LIKE '%".$search."%')";
							break;

							case 'price':
							$sql = "SELECT * FROM products WHERE `price` = ".$search;
							break;
							
							case 'views':
							$sql = "SELECT * FROM products WHERE `noviews` = ".$search;
							break;
							
							case 'type':
							//$sql = "SELECT * FROM products WHERE `type` LIKE '".$search."'";
							$sql = "SELECT * FROM `products` WHERE (CONVERT(`type` USING utf8) LIKE '%".$search."%')";
							break;
						}
