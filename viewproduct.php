				...
				<div class="box-content-1">
					<div class="box-product-1" >
						<?php
							...
							//$sql = "SELECT COUNT(*) FROM `main_menu`, sub_menu, products where main_menu.mmenu_id = sub_menu.mmenu_id and products.category = sub_menu.id and products.category = $item";
