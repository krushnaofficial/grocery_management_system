...
<?php
	...
	$sql = "SELECT COUNT(*) FROM cart , products, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'y' AND products.id = cart.product_id";
	$query = (mysqli_query($db_conx,$sql));
	...
	$selectproducts = "SELECT * FROM cart , products, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'y' AND products.id = cart.product_id";
...
<center>
<p><b>THANK YOU FOR CHOSING US<b></p>
</center>
</body>
</html>