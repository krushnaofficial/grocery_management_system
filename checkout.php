			...
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						$selectproducts = "SELECT * FROM cart , products, users WHERE cart.cust_id = $userid AND users.user_id = $userid AND cart.checkout = 'n' AND products.id = cart.product_id";
					...
					// End -->
						...
						<table border="1" align="center" width="300px">
							...
							<tr align="center">
								<td><b>GST</b></td><td><?php echo $vat1;?></td>
							</tr>
							<tr align="center">
								...
								<td bgColor="c6d3ce">
								  ...
								  <tr bgColor="dee7e7">
									...
									<tr bgColor="e7efef">
									  ...
									  <td><b><input type="text" size="10" maxlength="10" name="Tel" value="<?php echo $tel; ?>" disabled="TRUE" /></b></td>
									</tr>				
									<tr bgColor="e7efef">
									  <td><strong>Credit Card</strong></td>
									  <td><b><input type="text" size="15" maxlength="14" name="Card"  event.returnValue = false;"></b></td>
									</tr>
									</table>
								</td>
							</tr>
